...
11. שהכל יהיה על פי רוח התורה, ללא מילים לא ראויות, ובאווירה חרדית, 
    להוסיף איפה שנכון ברוך השם, ואיפה שנכון בעזרת השם וכן בסייעתא דשמייא
    ועוד מילים ומשפטם שמתאימים לרוח היהדות והחרדים והרבה הערכה לישיבות ולתורה ולציבור החרדי האיכותי, 
    וכן שהחדשות יהיו תמיד בהשקפה ימנית ולא שמולנית, כמובן את כל ההוספות הללו תעשה רק במקומות שמתאים להכניס, ובצורה יפה. 
